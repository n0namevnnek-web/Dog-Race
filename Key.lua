...
local Config = {
    ...
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/n0namevnnek-web/Dog-Race/refs/heads/main/Dog%20Race", -- The raw URL of your main script
    ...
    HubDescription  = "Dog Race | 1m Key" -- The text shown below the title
}
